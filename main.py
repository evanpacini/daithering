...
np_img = np.ctypeslib.as_array(img.contents.data_, shape=(
    img.contents.width_ * img.contents.height_,))
print(np_img)
...
print(np.ctypeslib.as_array(img2.contents.data_, shape=(
    img2.contents.width_ * img2.contents.height_,)))
